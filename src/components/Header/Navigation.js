...
function Navigation() {
    ...
    return (
        <header className="bg-gradient-to-r from-blue-900 to-gray-200 w-screen">
            ...
            {/* Dropdown Menu */}
            {/* <div className={`${isOpen ? "block" : "hidden"} w-screen bg-gradient-to-r from-green-800 to-gray-200 py-2 flex-col`}> */}
            <div className={`${isOpen ? "block" : "hidden"} w-screen bg-gradient-to-r from-blue-900 to-gray-200 py-2 flex-col`}>
                ...
                <ul>
                    ...
                    <li>
                        <Link to="/takeout" className="block px-4 py-2 text-black hover:bg-whitesmoke-700 hover:underline" onClick={() => setIsOpen(false)}>Takeout</Link>
                    </li>
                    <li>
                        <Link to="/menu" className="block px-4 py-2 text-black hover:bg-whitesmoke-700 hover:underline" onClick={() => setIsOpen(false)}>Menu</Link>
                    </li>
